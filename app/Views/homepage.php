   ...
   <div id="about" class="bg-custom text-light rainbow-row">
      <div class="row py-3" style="height: 200px">
         <div class="col-2 mx-5 px-1 bx-1 my-5 py-5 by-5">
            <img src="/Assets/Images/1X1.jpg" class="mt-1 rounded-circle" alt="" height="200" width="200">
         </div>
         ...
         <div class="col text-start fw-semibold">
            ...
            <img src="/Assets/Images/hi-hair-flip.gif" alt="a small singer hair flipping" height="120" width="120">
            <p class="fs-5">No.2 Eyes</p>
            <img src="/Assets/Images/flirty-eyes.gif" alt="a boy playing with his Eyes" height="120" width="120">
         </div>
      </div>
   </div>
      ...
      <div class="mt-4" >
         <div class="container">
            <div id="icons" class="row text-brown">
               <div class="col" >
                  <img src="/Assets/Images/ICES.png" alt="">
               ...
               <div class="col">
                  <img src="/Assets/Images/MANDU.png" alt="">
                  <div class="text-start text-center">
               ...
               <div class="col">
                  <img src="/Assets/Images/UniversityofSanAgustin-150px.png" alt="">
                  <div class="text-start text-center">
